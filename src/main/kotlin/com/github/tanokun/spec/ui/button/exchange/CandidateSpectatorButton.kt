...
class CandidateSpectatorButton(private val target: Player, private val ui: RandomlyExchangeSpectatorsUI): AbstractItem() {
    ...
    override fun handleClick(clickType: ClickType, cilcker: Player, event: InventoryClickEvent) {
        ...
        ui.selectedSpectators[target.uniqueId] = true
