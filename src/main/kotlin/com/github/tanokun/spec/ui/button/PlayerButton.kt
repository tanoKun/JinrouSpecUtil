...
private const val WHEN_BE_HEAD_TEXTURE = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmQyMDY1ZjJkMjA2YzBiNWQwMmMzNzY5ZGVmYzg5ZWU5YzUwMGZjMjYwMGY4NzA1NmQxYWEwNDk4NmRjZWEyMSJ9fX0="
...
class PlayerButton(private val target: Player, private val selectUI: SelectUI): AbstractItem() {
    ...
    override fun handleClick(clickType: ClickType, player: Player, event: InventoryClickEvent) {
        ...
        if (PlayerFilter.CurrentSpectator.filter(player)) target.unregisterPlayer()
